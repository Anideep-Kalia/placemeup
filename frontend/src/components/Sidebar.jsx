...
function Sidebar({active}) {
  return (
    ...
    <div className="w-full " >
      <Link to="/user-dashboard" className="w-full flex items-center justify-start py-4 ">
        <RxDashboard
          size={20}
    ...
    <div className="w-full ">
      <Link to="/user-opportunity" className="w-full flex items-center justify-start py-4">
        <MdOutlineWork
          size={20}
    ...
    <div className="w-full">
      <Link to="/user-applications" className="w-full flex items-center justify-start py-4">
